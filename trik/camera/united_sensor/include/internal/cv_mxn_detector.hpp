#ifndef TRIK_VIDTRANSCODE_CV_INTERNAL_CV_MXN_DETECTOR_HPP_
#define TRIK_VIDTRANSCODE_CV_INTERNAL_CV_MXN_DETECTOR_HPP_
...
class MxnDetector : public CVAlgorithm,
...
#include "internal/cv_mxn_detector_seqpass.hpp"
