#ifndef TRIK_VIDTRANSCODE_CV_INTERNAL_CV_OBJECT_DETECTOR_SEQPASS_HPP_
#define TRIK_VIDTRANSCODE_CV_INTERNAL_CV_OBJECT_DETECTOR_SEQPASS_HPP_
...
template <>
class ObjectDetector<TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_YUV422, TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_RGB565X> : public CVAlgorithm
{
  private:
...
uint16_t* restrict ObjectDetector<TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_YUV422,
