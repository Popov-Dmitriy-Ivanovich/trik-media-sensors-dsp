...
template <>
class JPGEncoderWrapper<TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_YUV422, TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_RGB565X> : public CVAlgorithm
{
  private:
  ...
  public:
                     ...
                     const TrikCvAlgInArgs& _inArgs, TrikCvAlgOutArgs& _outArgs)
    {
      ...
      jpgEncoder.init(_inArgs.jpgImageQuality, _inArgs.ifBlackAndWhite,m_inImageDesc.m_format==TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_YUV422);//no checks needed for they are conducted in jpgEncoder.
