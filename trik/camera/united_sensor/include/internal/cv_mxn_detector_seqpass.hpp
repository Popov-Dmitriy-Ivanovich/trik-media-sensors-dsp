  #ifndef TRIK_VIDTRANSCODE_CV_INTERNAL_CV_MXN_DETECTOR_SEQPASSMXN_HPP_
#define TRIK_VIDTRANSCODE_CV_INTERNAL_CV_MXN_DETECTOR_SEQPASSMXN_HPP_
...
//static uint64_t s_rgb888hsv[640*480]; defined in cv_line_detector_seqpass
//static uint32_t s_wi2wo[640]; defined in cv_ball_detector_seqpass
//static uint32_t s_hi2ho[480]; defined in cv_ball_detector_seqpass
...
/*union U_Hsv8x3
{
    ...
    uint32_t whole;
};defined in cv_hsv_range_detector*/

template <>
class MxnDetector<TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_YUV422, TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_RGB565X> : public CVAlgorithm
{
  private:
    uint8_t m_heightM;
    uint8_t m_widthN;
    ...
    {
      if(this->m_inImageDesc.m_format==TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_YUV422)
      {
...
uint16_t* restrict MxnDetector<TRIK_VIDTRANSCODE_CV_VIDEO_FORMAT_YUV422,
